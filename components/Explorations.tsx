...
const ExplorationCard: React.FC<ExplorationCardProps> = ({ item, delay, navigate }) => {
    ...
    return (
        <a 
            ...
            className="relative block bg-gradient-to-br from-[var(--surface)] to-transparent rounded-xl border border-[var(--border)] transition-all duration-300 hover:border-[var(--accent)]/40 hover:-translate-y-1 group opacity-0 overflow-hidden"
